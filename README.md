A fasting tracker app that doesn't show ads or collect data. Written with web technologies has the browser as the execution environment to maintain the users data with them.
